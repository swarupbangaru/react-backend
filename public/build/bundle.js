...
var Home = function (_React$Component) {
    ...
    _createClass(Home, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'container', style: _styles2.default.container },
                _react2.default.createElement(
                    'div',
                    { className: 'col-md-4' },
...
var Zones = function (_React$Component) {
    ...
    _createClass(Zones, [{
        ...
        value: function componentDidMount() {
            ...
            _superagent2.default.get('/api/zone').query(null).set('Accept', 'Applcation/json').end(function (err, response) {
                if (err) {
                ...
                _this2.setState({ lists: ll });
                console.log("list is:" + JSON.stringify(_this2.state.lists));
            });
        }
    }, {
        key: 'onsubmit',
        ...
        value: function render() {
            ...
            var listitem = this.state.list.map(function (zone, i) {
                return _react2.default.createElement(
                    'li',
                    { key: i },
                    _react2.default.createElement(_Zone2.default, { curntzone: zone })
                );
            });
            return _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement('input', { type: 'text', onChange: this.namechange.bind(this), ref: 'name', placeholder: 'name' }),
                _react2.default.createElement('input', { type: 'text', onChange: this.passwordchange.bind(this), ref: 'passwor', placeholder: 'password' }),
                _react2.default.createElement(
                    'button',
    ...
    _createClass(Zone, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { href: '#', className: 'h3', style: _styles2.default.container },
                    this.props.curntzone.name
                ),
                _react2.default.createElement(
                    'h5',
                    null,
...
var Comments = function (_Component) {
    ...
    _createClass(Comments, [{
        ...
        value: function render() {
            ...
            var listitems = this.state.comentlist.map(function (coment, i) {
                return _react2.default.createElement(
                    'li',
                    { key: i },
                    _react2.default.createElement(_Comment2.default, { curnt: coment })
                );
            });
            return _react2.default.createElement(
                'div',
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h5',
                    null,
                    this.props.curnt.body
                ),
                _react2.default.createElement(
                    'h5',
                    null,
                    this.props.curnt.time
                )
            );
        }
    }]);
